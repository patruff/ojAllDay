        ...
        const funnyResponse = await fetch(baseUrl, {
            ...
            body: JSON.stringify({
                messages: [
                    ...
                    { 
                        role: "user", 
                        content: "Generate 250 tweet/thought pairs in valid JSON array format. Each object should have 'tweet' and 'thoughts' fields. The tweets should be what OJ posts publicly, while the thoughts reveal his obsession with not being cucked and his rage about Nicole seeing other men. Make frequent references to cucks, cucking, and how you proved you weren't one. Include lots of references to blood, knives, and possessiveness. Example: [{\"tweet\": \"Sometimes you have to show people who's boss!\", \"thoughts\": \"Nicole thought she could cuck THE JUICE? That waiter thought he could step to OJ's woman? Guess who's the cuck now... oh wait, they're both dead. 🔪\"}, {\"tweet\": \"Loyalty is everything in relationships.\", \"thoughts\": \"She tried to make me look like some weak cuck. But I showed her and that pretty boy what happens when you cross The Juice. No one cucks OJ and lives to tell about it.\"}]"
                    }
                ],
                model: "grok-beta",
                stream: false
        ...
        const wisdomResponse = await fetch(baseUrl, {
            ...
            body: JSON.stringify({
                messages: [
                    ...
                    { 
                        role: "user", 
                        content: "Generate 250 'wisdom' tweet/thought pairs in valid JSON array format. Each object should have 'tweet' and 'thoughts' fields. The tweets should be life lessons OJ posts publicly, while the thoughts reveal his obsession with not being cucked and his satisfaction at killing those who tried. Make frequent references to blood, possessiveness, and dominance. Example: [{\"tweet\": \"Never let anyone disrespect you in a relationship.\", \"thoughts\": \"Nicole thought she could cuck me with that pretty boy waiter? The Juice doesn't get cucked. The blood proved who's really the alpha.\"}, {\"tweet\": \"Stand up for yourself, no matter what.\", \"thoughts\": \"They thought OJ would just sit there and take it like some weak cuck? Nicole learned the hard way - nobody makes The Juice look like a cuck and survives.\"}]"
                    }
                ],
                model: "grok-beta",
                stream: false
